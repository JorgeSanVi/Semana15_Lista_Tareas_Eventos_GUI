...
En esta tarea desarrollé una aplicación de escritorio en Python utilizando Tkinter. La aplicación me permite agregar, completar y eliminar tareas mediante una interfaz gráfica sencilla. Para cumplir con la guía, organicé el proyecto por capas, separando el modelo, la lógica del sistema y la interfaz.
